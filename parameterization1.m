...
Params.AL = Params.A0*Params.L0; % effective labor % here 37.842

% Emissions intensity of production
Params.sigma0 = 0.13418;  % CO2 equivalent emission-GDP ratio
Params.gsigma0_dec = -0.0730;  %initial growth rate of decarbonization (*100 gives %)
Params.dsigma = 0.003; % rate of decline of decarbonization (*100 gives %)

% Annual depreciation rate of capital stock
Params.deltak = 0.1; % note that this was formerly defined as 0.9 = 1 - depreciation rate
